...
public class RangeEval {
	...
	public static RangeEval create(String range) throws Exception {
		...
		// 입력값 검증
		if(range == null || range.trim().equals("") == true) {
	 ...
	 * @return 시작 셀의 row 값
	 */
	public int evalStartRow(Map<String, Object> values) throws Exception {
	 ...
	 */
	public int evalStartColumn(Map<String, Object> values) throws Exception {
	 ...
	 * @return 종료 셀의 row 값
	 */
	public int evalEndRow(Map<String, Object> values) throws Exception {
	 ...
	 */
	public int evalEndColumn(Map<String, Object> values) throws Exception {
